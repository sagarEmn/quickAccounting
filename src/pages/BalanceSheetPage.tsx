...
export const BalanceSheetPage: React.FC = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Balance Sheet</h1>
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <Sheet onOpenChange={setIsFilterOpen} open={isFilterOpen}>
          ...
          <BalanceSheetFilter isOpen={isFilterOpen} onOpenChange={setIsFilterOpen} />
        </Sheet>
      </div>

      {/* Display date range */}
      <p className="text-sm text-gray-600 mb-4">
        Showing balance sheet for the period of 01/06/2025 to 01/06/2025
      </p>
