...
export const BalanceSheetFilter: React.FC<BalanceSheetFilterProps> = ({
  ...
  const applyFilters = () => {
    console.log("Applied balance sheet filters:", filters);
    onOpenChange(false);
  };
  ...
  return (
    <SheetContent side="right" className="w-full sm:max-w-md">
      <SheetHeader className="px-6 pt-6 pb-4">
        ...
        <p className="text-sm text-gray-500">Customize your balance sheet view</p>
      </SheetHeader>
      ...
      <div className="px-6 py-4 flex flex-col space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox 
              id="showComparativeData" 
              checked={filters.showComparativeData}
              onCheckedChange={() => handleCheckboxChange("showComparativeData")}
            />
            <Label htmlFor="showComparativeData" className="text-sm font-medium">
